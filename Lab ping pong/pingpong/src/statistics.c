...
/*** TO BE DONE START ***/
	double delta_seconds = last->tv_sec - previous->tv_sec;
	double delta_nanoseconds = last->tv_nsec - previous->tv_nsec;
	
	return delta_seconds * 1000 + delta_nanoseconds / 10000000;
